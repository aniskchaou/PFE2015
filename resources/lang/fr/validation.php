...
return array(
    ...
    */
    'attributes' => array(
        ...
        "etudiant_cin"=>" Numero CIN",
        "stage_title"=> "Titre de stage", 
        "type_id"=>"Type de stage",
        "stage_sujet"=>"",
        "stage_dete_debut"=>"Date début",
        "stage_dete_fin"=>"Date fin",
        "filiere_id"=>"Filiere",
        "stage_sujet"=>"Sujet de stage",
        "stage_nbr_etudiant"=>"Nombre de candidat",
        "emploi_titre"=>"Titre",
        "emploi_nbr"=>"Nombre de postes",
        "emploi_date_fin"=>"Date de fin",
        "ent_id"=>"Entreprise",
        "filiere_id"=>"Filiere",
        "emploi_competence"=>"Competence",      
        "datet"=>"Date et heure de début",
        "duree"=>"Durée",
        "ent_nom"=>"Nom",
        "ent_statut_juridique"=>"Statut juridique",
        "ent_nbr"=>"Effectif",
        "ent_adresse"=>"Adresse",
        "ent_pays"=>"Pays",
        "ent_ville"=>"Ville",
        ...
        "tel"=>"Téléphone",
        "Login"=>"Pseudo",
        "Verification_Email"=>"Vérification_Email",
        "enmp"=>"Ancien mot de passe",
        "VMot"=>"Vérification Mot de passe",
        "filiere_nom"=>"Nom filière",
        "filiere"=>"filière",
        "types"=>"Type de stage",
        "anner"=>"Année Universitaire",
        "niveau"=>"Niveau",
