						...
						<div class="list-group">
						 ...
						 <strong> Aujourd'hui</strong>  <span class="badge"><strong><?php echo date('d/m/y h:i');?></strong> </span>
						  ...
						  <a href="{{ route('soutenance.souteNonPlanifie')}}" class="list-group-item">
						            	@foreach($StNsEnAtt as $Nb)
										Soutenance(s) en attente <span class="badge">{{$Nb->nb}}</span>
										@endforeach</a>
						  <a href="{{ url('stage/stageEnAttente')}}" class="list-group-item">Stage(s) en attente<span class="badge">{{ $NBSNT }}</span></a>
						  <a href="{{ url('/offre_d_emploi/emploiEnAttente')}}" class="list-group-item">Emploie(s) en attente<span class="badge">{{$NbOffre}}</span></a>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<h4><p>
										vous avez {{ $NBSNT }} stage(s) en attente
								    </p></h4>
									<p>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<h4><p>
										@foreach($StNsEnAtt as $Nb)
										Vous avez {{$Nb->nb}} soutenance(s) en attente 
										@endforeach
									</p></h4>
									<p>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<h4><p>
                                     vous avez {{$NbOffre}} offre(s) d'emploi(s) en attente
								    </p></h4>	
									<p>
