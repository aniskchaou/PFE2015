...
<link rel="stylesheet" type="text/css" href="{{ asset('/media/css/dataTables.colVis.min.css')}}" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="{{ asset('/media/css/dataTables.colvis.jqueryui.css')}}" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="{{ asset('/media/3/dataTables.bootstrap.css')}}">

<link rel="stylesheet" type="text/css" href="{{ asset('/menu/jquery.smartmenus.bootstrap.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('/chosen/chosen.bootstrap.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{ asset('/chosen/navbar-custom.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('/text/src/bootstrap3-wysihtml5.css')}}"> 
<link rel="stylesheet" type="text/css" href="{{ asset('/spiner.css')}}"> 
	...
	<nav class="navbar  navbar-custom  navbar-static-top  navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"style=" font-weight:bold"><i>Stage+</i></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					@if (Auth::guest())
					   <ul class="nav navbar-nav navbar-right">
						<li><a href="{{ url('/auth/login') }}">Se Connecter &nbsp;&nbsp;<i class="fa fa-sign-in fa-lg"></i>&nbsp;</a></li>
                    ...
                    <li class="dropdown">
				          ...
				          <li class="dropdown">
                               ...
                               <ul class="dropdown-menu" role="menu">
                                  ...
                                  <!--   <li><a href="#">
                                    ...
                                    <li>
                                      <a href="#" >
                                      <span class="glyphicon glyphicon-print"></span> États</a>
                                     <ul class="dropdown-menu">                                  
                                    <li>
                                      <a href="#" >
                                      <span class="glyphicon glyphicon-folder-open"></span> Stage</a>
                                        <ul class="dropdown-menu">
                                          ...
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer fiches stages</a></li> 
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer résumés stages</a></li>
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer les lettres d'affectations</a></li>   
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer les remerciments d'entreprises</a></li> 
                                        </ul> 
                                    </li>
                                    <li>
                                      <a href="#" >
                                      <span class="glyphicon glyphicon-folder-close"></span> Soutenances</a>
                                        <ul class="dropdown-menu">
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer les fiches d'évaluation</a></li>
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer les invitations industrielle</a></li> 
                                          <li><a href="#" ><span class="glyphicon glyphicon-print"></span> imprimer les invitations d'enseignants</a></li>
                                    ...
                                    <li>
                                      <a href="#" >
                                      <span class="glyphicon glyphicon-list-alt"></span>  En-tête et pied de page</a>
                                        <ul class="dropdown-menu">
					   ...
					   <ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><!-- <img alt="Brand" src="...">--> <i class="fa fa-user fa-lg"></i> {{ Auth::user()->name }} </a>
							<ul class="dropdown-menu" role="menu">

								
								<li><a href="{{ url('/user') }}" ><span class="glyphicon glyphicon-search"></span> consulter mon profil</a></li>
							     <li><a href="#" ><span class="glyphicon glyphicon-pencil"></span> modifier profil</a>
                                  <ul class="dropdown-menu">
                                   <li><a href="{{route('user.edit',Auth::user()->id) }}" ><span class="glyphicon glyphicon-user"></span> profile</a></li>
                                   <li><a href="{{route('user.modifEmail',Auth::user()->id)}}" ><span class="glyphicon glyphicon-envelope"></span> email</a></li>
                                   <li><a href="{{route('user.modifMotPasse',Auth::user()->id)}}" ><span class="glyphicon glyphicon-lock"></span> mot de passe</a></li>
                                  </ul>
                                 </li>
                                <li class="divider"></li> 
                              <li><a href="{{ url('/auth/logout') }}"><span class="glyphicon glyphicon-log-out"></span> Déconnexion</a></li>
...
<i>Stage+</i>&nbsp;© 2014 - 2015 sommaire du site/ contact
