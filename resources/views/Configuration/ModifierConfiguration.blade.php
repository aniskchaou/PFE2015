		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="{{ url('configuration/'.$Cnf->id)}}">
                 ...
                 <div class="form-group">
                          ...
                          <div class="input-group spinner">
                             <input type="text" class="form-control" id="type_dur_min" name="soutenance_dur_max" value="{{$Cnf->soutenance_dur_max}}">
                    ...
                    <script type="text/javascript">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-4">									
						      <div class="input-group spinner">
						       <input type="text" class="form-control" name="nbr_elemont"   id="type_dur_max" value="{{$Cnf->nbr_elemont}}">
						         <div class="input-group-btn-vertical">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-8">                     
                             <textarea class="form-control" rows="9" id="some-textarea" LANG="fr" data-placeholder="Compétence" name="introdu">{{$Cnf->introdu}}</textarea>                             
                             <script type="text/javascript">
