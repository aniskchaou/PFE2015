...
class EntrepriseController extends Controller {
  ...
  public function store(Request $request)
  {
    ...
    if ($v->fails())
    {
     ...
     $Entreprise = Entreprise::create( Input::all());
    $Entreprise->save();
  ...
  $Entreprise = Entreprise::find($id);    
    ...
    $Entreprise->ent_nom=Input::get('ent_nom');
    $Entreprise->ent_statut_juridique=Input::get('ent_statut_juridique');
    $Entreprise->secteur_id=Input::get('secteur_id');
    $Entreprise->ent_nbr=Input::get('ent_nbr');
    $Entreprise->ent_adresse=Input::get('ent_adresse');
    $Entreprise->ent_pays=Input::get('ent_pays');
    $Entreprise->ent_ville=Input::get('ent_ville');
    $Entreprise->ent_fax=Input::get('ent_fax');
    $Entreprise->ent_tel=Input::get('ent_tel');
    $Entreprise->ent_web=Input::get('ent_web');
