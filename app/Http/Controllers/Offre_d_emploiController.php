  ...
  { 
    ...
    if ($v->fails())
    {
       ...
       $Offre_d_emploi = Offre_d_emploi::create(    
                                 array(  'emploi_titre'=>Input::get('emploi_titre'),
                                         'emploi_nbr'=>Input::get('emploi_nbr'),
                                         'emploi_date_fin'=>Input::get('emploi_date_fin'),
                                         'ent_id'=>Input::get('ent_id'),
                                         'emploi_competence'=>Input::get('emploi_competence'),
   ...
   /*      $Entreprise=Entreprise::find(Input::get('ent_id'));
...
try {
  ...
  public function update($id,Request $request)
  {
    ...
    $Offre_d_emploi = Offre_d_emploi::find($id);  
                         $Offre_d_emploi->emploi_titre=Input::get('emploi_titre');
                           $Offre_d_emploi->emploi_nbr=Input::get('emploi_nbr');
                      $Offre_d_emploi->emploi_date_fin=Input::get('emploi_date_fin');
                               $Offre_d_emploi->ent_id=Input::get('ent_id');
                    $Offre_d_emploi->emploi_competence=Input::get('emploi_competence');
                        $Offre_d_emploi->emploi_status=Input::get('emploi_status');
