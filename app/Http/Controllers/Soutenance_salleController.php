  ...
  public function store(Request $request)
  {
    ...
    if ($v->fails())
    {
        return redirect()->back()->withErrors($v->errors())->withInput();
         ...
         'salle_nom'=>Input::get('salle_nom'),
         'salle_nb_plase'=>Input::get('salle_nb_plase')
  ...
  public function update($id,Request $request)
  {
    ...
    if ($v->fails())
    {
        return redirect()->back()->withErrors($v->errors())->withInput();
         ...
         $Soutenance_salle = Soutenance_salle::find($id);
         $Soutenance_salle->salle_nom=Input::get('salle_nom');
         $Soutenance_salle->salle_nb_plase=Input::get('salle_nb_plase');
