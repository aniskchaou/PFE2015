  ...
  public function store(Request $request)
  {
    ...
    if ($v->fails())
    {
     ...
     $Enseignant = Enseignant::create(   array( 
                                                 'enseig_code'=> Input::get('enseig_code'), 
                                                 'enseig_prenom'=> Input::get('enseig_prenom'), 
                                                 'enseig_nom'=> Input::get('enseig_nom'), 
                                                 'enseig_sexe'=> Input::get('enseig_sexe'), 
                                                 'enseig_tel'=> Input::get('enseig_tel'), 
                                                 'enseig_mobile'=> Input::get('enseig_mobile'), 
                                                 'enseig_adresse'=> Input::get('enseig_adresse'), 
                                                 'enseig_grade_code'=>'',
                                                 'enseig_grade_nom'=> Input::get('enseig_grade_nom'),
                                                 'enseig_specialite_code'=>'',
                                                 'enseig_specialite_nom'=> Input::get('enseig_specialite_nom'), 
                                                 'enseig_status_code'=>'', 
                                                 'enseig_status_nom'=>'', 
...
$Enseignant = Enseignant::find($id);
     ...
     $Enseignant->enseig_code= Input::get('enseig_code'); 
     $Enseignant->enseig_prenom= Input::get('enseig_prenom');
     $Enseignant->enseig_nom=Input::get('enseig_nom');
     $Enseignant->enseig_sexe= Input::get('enseig_sexe');
     $Enseignant->enseig_tel= Input::get('enseig_tel') ;
     $Enseignant->enseig_mobile= Input::get('enseig_mobile') ;
     $Enseignant->enseig_adresse= Input::get('enseig_adresse');
     $Enseignant->enseig_grade_code='';
     $Enseignant->enseig_grade_nom= Input::get('enseig_grade_nom');
     $Enseignant->enseig_specialite_code='';
     $Enseignant->enseig_specialite_nom= Input::get('enseig_specialite_nom') ;
     $Enseignant->enseig_status_code='';
     $Enseignant->enseig_status_nom='';
     $Enseignant->email= Input::get('email');
